...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        private void EyeRaycast()
        {
            ...
            Ray ray = new Ray(m_Camera.position, (rays.left.direction + rays.right.direction) / 2);

            if (m_ShowDebugRay)
            {
                Debug.DrawRay(m_Camera.position, ray.direction, Color.blue, m_DebugRayDuration);
            }
