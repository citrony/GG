...
namespace VRStandardAssets.Utils
{
    ...
    public class Reticle : MonoBehaviour
    {
        ...
        public Transform m_ReticleTransform;      // We need to affect the reticle's transform.
        ...
        public void SetPosition ()
        {
            ...
            m_ReticleTransform.position = m_Camera.position + (rays.left.direction + rays.right.direction) / 2 * m_DefaultDistance;
