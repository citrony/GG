...
public class EnemyRotate4 : MonoBehaviour
{
    ...
    void EnemyBuster()
    {
        ...
        Instantiate(ScoreMotion40, new Vector3(transform.position.x, transform.position.y + 4, transform.position.z), Quaternion.identity);
